    ...
    <div className="max-w-md mx-auto mt-10 p-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <button
            type="submit"
            className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#3b82f6] hover:bg-[#1e40af] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
